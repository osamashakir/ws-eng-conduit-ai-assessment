...
1. **Set Up GitHub Codespaces:**
   ...
   - Open the Codespace using [this link](https://github.com/codespaces/new?repo=678723453&ref=rwa/feature-development-v5&machine=standardLinux32gb).
...
5. **Use Cline to implement the feature:**
   ...
   - Use Cline to perform most of the research, design, write new code, etc.
...
- **Use the Correct Branch**: Other assessment branches are in the repository. You must be on rwa/feature-development-v5.
